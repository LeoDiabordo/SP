                ...
                <div class="row">
                    ...
                    <div class="row">
                        <form method='post' action='<?php echo base_url('/index.php/c_user/add_info')?>'>
                            ...
                            <input type="text" name="grad-bdate" id="grad-bdate"/>
                            </div>
                                    ...
                                    <option value="-1">Select country</option>
                                        <?php
                                            foreach($list->result() as $listElement){
                                                ?>
                                                    <option value="<?php echo $listElement->id?>"><?php echo $listElement->printable_name?></option>
                                                <?php
                                            }
                                        ?>
                                </select>
                            ...
                            <!-- <div class="large-12 columns">
                                <div class="large-4 columns">
                                <label> Country</label>
                                <select name="grad-current-add-country">
